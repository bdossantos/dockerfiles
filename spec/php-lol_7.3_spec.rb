...
describe 'Dockerfile' do
  ...
  describe file('/usr/sbin/nginx') do
    ...
    its(:sha256sum) {
      should eq \
        '3eccf9ea7859c8ca8bec48926ac50c08e67852166d2508517bc7874aedf5c75f'
    }
  end
  ...
  describe file('/usr/local/bin/php') do
    ...
    its(:sha256sum) {
      should eq \
        '7eac3a4b78da9fbbb993e7dededff35bf66aef0d53097eca9e54b9ece69a50fe'
    }
  end
  ...
  describe file('/usr/local/sbin/php-fpm') do
    ...
    its(:sha256sum) {
      should eq \
        '5aba08d467cbc2462fa3da512d26f8018fd384941f59f38cc788ba6224061085'
    }
  end
