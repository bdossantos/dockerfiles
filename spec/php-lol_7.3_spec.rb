...
describe 'Dockerfile' do
  ...
  describe file('/usr/sbin/nginx') do
    ...
    its(:sha256sum) {
      should eq \
        '69c06be89faf60ac8a39549b7d5c2b6dbef5a919ce4ba4b63c462c801afa9af7'
    }
  end
  ...
  describe file('/usr/local/bin/php') do
    ...
    its(:sha256sum) {
      should eq \
        'e61140f1bc555c3a7db68fd88b07cebd1b7c417624eb73da5787258bc8c9533c'
    }
  end
  ...
  describe file('/usr/local/sbin/php-fpm') do
    ...
    its(:sha256sum) {
      should eq \
        'f423ac50318e0c50f6cc393ec750aec53f4f74d2b99663d35a0527f5db49dd1a'
    }
  end
  ...
  describe file('/usr/local/etc/php/php.ini') do
    ...
    its(:sha256sum) {
      should eq \
        '8230e6a3cd9cd51412152f30ce81b66334f3392bad3dccfa550499b90808fb77'
    }
  end
  ...
  describe file('/usr/local/etc/php-fpm.d/zzz-php-fpm-tuning.conf') do
    ...
    its(:sha256sum) {
      should eq \
        '338b70af312e55fa98cc53dd86c8517427af7853689cd838eccfc1f506a46313'
    }
  end
