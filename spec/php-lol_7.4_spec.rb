...
describe 'Dockerfile' do
  ...
  describe file('/usr/local/bin/php') do
    ...
    its(:sha256sum) {
      should eq \
        'fbda1fdd0f3e596b9a7e328e0727a4d716d98786ef7e2e8eb2060f4d59ec542f'
    }
  end
  ...
  describe file('/usr/local/sbin/php-fpm') do
    ...
    its(:sha256sum) {
      should eq \
        '67ec2df65504d788ba78be830a6ab91ad243d13c10290f035887d760bc806ec7'
    }
  end
  ...
  describe file('/usr/local/etc/php/php.ini') do
    ...
    its(:sha256sum) {
      should eq \
        'ef8c76ad643561a45dac1c14c2271d1cacf77cf0a9463357f918eb96db07b544'
    }
  end
